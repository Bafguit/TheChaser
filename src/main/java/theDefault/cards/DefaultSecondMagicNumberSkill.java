...
public class DefaultSecondMagicNumberSkill extends AbstractDynamicCard {
    ...
    public static final String ID = TheChaserMod.makeID(DefaultSecondMagicNumberSkill.class.getSimpleName());
    ...
    public static final CardColor COLOR = TheChaser.Enums.COLOR_GRAY;
