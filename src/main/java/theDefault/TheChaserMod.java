...
import theDefault.variables.MagicNumber2;
...
public class TheChaserMod implements
    ...
    public void receiveEditRelics() {
        ...
        BaseMod.addRelicToCustomPool(new PlaceholderRelic(), TheChaser.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new BottledPlaceholderRelic(), TheChaser.Enums.COLOR_GRAY);
        BaseMod.addRelicToCustomPool(new DefaultClickableRelic(), TheChaser.Enums.COLOR_GRAY);
