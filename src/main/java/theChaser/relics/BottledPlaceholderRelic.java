...
import theChaser.patches.relics.BottledPlaceholderField;
import theChaser.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theChaser.TheChaserMod.makeRelicOutlinePath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = TheChaserMod.makeID("BottledPlaceholderRelic");
