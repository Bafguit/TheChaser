...
public class PenetrativePower extends AbstractPower implements CloneablePowerInterface, OnTargetAttackSubscriber {
    ...
    private static final Texture tex84 = TextureLoader.getTexture("theChaserResources/images/powers/pene84.png");
    private static final Texture tex32 = TextureLoader.getTexture("theChaserResources/images/powers/pene32.png");

    public PenetrativePower(final AbstractCreature owner, int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new PenetrativePower(owner, amount);
    }
}
